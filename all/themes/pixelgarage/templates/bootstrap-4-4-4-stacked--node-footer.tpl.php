...
<<?php print $layout_wrapper; print $layout_attributes; ?> class="<?php print $classes; ?>">
  ...
  <?php if ($left || $central || $right): ?>
    <div class="row">
      <<?php print $left_wrapper; ?> class="col-xs-4 left <?php print $left_classes; ?>">
        <div class="icon-facebook"></div>
        <?php print $left; ?>
      </<?php print $left_wrapper; ?>>
      <<?php print $central_wrapper; ?> class="col-xs-4 middle <?php print $central_classes; ?>">
        <?php print $central; ?>
      </<?php print $central_wrapper; ?>>
      <<?php print $right_wrapper; ?> class="col-xs-4 right <?php print $right_classes; ?>">
